...
L.control.layers(baseMaps, overlays).addTo(map);
  ...
  // Create a variable for the major earthquake geoJSON data
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // Here we create an All Earthquakes legend control object.
...
// Listen to event "overlayadd" to display the right legend for the selected data.
map.on('overlayadd', function(eventLayer) {
  console.log("clicked on overlay: " + eventLayer.name);
  if (eventLayer.name === 'majorEarthquakes') { 
    majorEQlegend.addTo(map);
    map.removeControl(allEQlegend); 
  } else {
    map.removeControl(majorEQlegend);
  }
});